...
@Sql(value = ["/sql/clean.sql", "/sql/ShareMonthlyImporter.sql"])
internal class ShareMonthlyImporterTest {
    @Autowired
    private lateinit var importer: ShareMonthlyImporter
    ...
    private fun assertMonthlyStat(year: Int, month: Int, productId: Long, value: Long, merchantId: Long) {
        ...
        assertEquals(value, stat.shareCount)
